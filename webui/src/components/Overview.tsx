...
class Overview extends React.Component<OverviewProps, OverviewState> {
    ...
    // show session
    showSessionPro = (ExperimentID ?: string) => {
        ...
        axios(`${MANAGER_IP}/experiment`, {
            ...
            headers:{
                ...
                'ExperimentID': HeaderExperimentID
            }
        })
            .then(res => {
                if (res.status === 200) {
    ...
    showTrials = (ExperimentID ?: string) => {
        const HeaderExperimentID = ExperimentID !== undefined ? ExperimentID: this.state.ExperimentID
        this.isOffInterval();
    ...
    componentWillReceiveProps(nextProps: OverviewProps) {
        ...
        if(nextProps.ExperimentID !== this.props.ExperimentID){
            ...
            this.showTrials(nextProps.ExperimentID);
            this.showSessionPro(nextProps.ExperimentID);
        }
...
export default connect<any, any, any>((state,props)=>({port:state.PortReducer, ExperimentID: state.ExperimentReducer}) )(Overview);
